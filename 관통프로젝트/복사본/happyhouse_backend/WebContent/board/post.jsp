			...
			<div class="menu-bg-wrap">
				<div class="site-navigation">
					<ul
						...
						<li class="items"><a href="mypage.jsp">My Page</a></li>
					</ul>
				</div>
			</div>
			<div class="title" style="color: white">
				<h2 style="font-weight: bold">HAPPY HOUSE</h2>
			</div>
		</div>
	</header>
				...
				<tbody>
					<c:forEach var="article" items="${boardlist}">
						<tr class="text-center">
							...
							<td class="text-start">
							<a href="#"
								class="article-title link-dark" data-no="${article.article_no}"
							...
							<td>
								<form action="<%=root %>/book/bookUpdate.jsp" method="post">
									<input type="hidden" name="isbn" value="${article.article_no}">
									<input type="hidden" name="isbn" value="${article.title}">
									<input type="hidden" name="isbn" value="${article.user_id}">
									<input type="hidden" name="title" value="${article.hit}">
									<input type="hidden" name="author" value="${article.register_time}">
